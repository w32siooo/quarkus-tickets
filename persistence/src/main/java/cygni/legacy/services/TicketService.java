                        ...
                        session
                                ...
                                .onItem().ifNotNull().transformToMulti(resultList ->
                                        Multi.createFrom().iterable(resultList)
                                                ...
                                                )).onItem().invoke(eventAggregate::applyAndValidateEvent)
                                                .select().last()).toUni().replaceWith(eventAggregate)
        );
    }
                        ...
                        session
                                ...
                                .onItem().ifNotNull().transformToMulti(resultList ->
                                        Multi.createFrom().iterable(resultList)
                                                ...
                                                )).onItem().invoke(userTicketAggregate::applyAndValidateEvent)
                                                .select().last()).toUni().replaceWith(userTicketAggregate)
        );
    }
